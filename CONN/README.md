# ProMicro_CONN [![build](https://github.com/nerdyscout/ProMicro/workflows/kicad-exports/badge.svg?branch=CONN)](CONN/actions?query=branch%3ACONN)
...
### BoM
  ...
  * [octopart](docs/bom/CONN-bom_octopart.csv)
